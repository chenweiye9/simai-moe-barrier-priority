...
int main(int argc,char *argv[]){
  ...
  const char* logRoot = std::getenv("SIMAI_LOG_DIR");
  std::string result_prefix = (logRoot ? std::string(logRoot) : (std::string(std::getenv("HOME")) + "/.simai")) + "/results/ncclFlowModel_";
  #ifdef PHY_RDMA
