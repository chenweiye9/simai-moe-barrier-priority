...
OUT_DIR="${ROOT_DIR}/experiments/moe_small/output_incast_ep8"
...
run_case strict_tail 1 1 1.0 1.0 0
run_case laggard_tail 1 7 0.25 1.10 4194304

echo "Done. Summaries:"
sed -n '1,20p' "${OUT_DIR}/baseline.summary.txt"
sed -n '1,20p' "${OUT_DIR}/strict_tail.summary.txt"
